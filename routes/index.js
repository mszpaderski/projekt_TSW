...
router.route('/admin_p/all').get(function(req, res, next) {
...
router.route('/judge_p/all').get(function(req, res, next) {
...
router.get('/admin_p/:id/edit', function(req, res) {
...
router.get('/judge_p/:id/edit', function(req, res) {
...
router.delete('/admin_p/:id/edit', function (req, res){
    //find admin by ID
    mongoose.model('Admin').findById(req.id, function (err, admin) {
        if (err) {
            return console.error(err);
...
router.delete('/judge_p/:id/edit', function (req, res){
    //find judge by ID
    mongoose.model('Judge').findById(req.id, function (err, judge) {
        if (err) {
            return console.error(err);
